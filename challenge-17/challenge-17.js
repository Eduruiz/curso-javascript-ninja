(function() {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Eduardo Marcal Ruiz'));
    ...
    */
    ...
    console.log(
        text.replace(/O Centauro de Luvas/g, function(total){
    ...
    */
    ...
    function getMonthNumber(month) {
        ...
        switch (month) {
            case 'janeiro':
                return monthNumber = '01';;
                break;
            case 'fevereiro':
                return monthNumber = '02';
                break;
            case 'março':
                return monthNumber = '03';
                break;
            case 'abril':
                return monthNumber = '04';
                break;
            case 'maio':
                return monthNumber = '05';
                break;
            case 'junho':
                return monthNumber = '06';
                break;
            case 'julho':
                return monthNumber = '07';
                break;
            case 'agosto':
                return monthNumber = '08';
                break;
            case 'setembro':
                return monthNumber = '09';
                break;
            case 'outubro':
    ...
    */
    ...
    function replaceDate(text) {
        return text.replace(regexDate, function(extenseDate, day, month, year){
