(function(){
    ...
    */
    console.log( '\nOperation:' );
    var operation = justMod2Or3.reduce(function(acumulado, valor, index){
    ...
    */
    ...
    var operation2 = justMod2Or3.reduceRight(function(acumulado, valor, index){
        return (acumulado + 1) * valor;
    }, 0);
    ...
    */
    ...
    var name = ['E', 'du', 'ar', 'do'];
    var nameP = name.reduce(function(acumulado, valor, index, array){
    ...
    */
    console.log( '\nInversed Name:' );
    var inversedName = name.reduceRight(function(acumulado, valor, array){
